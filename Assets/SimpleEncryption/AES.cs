...
namespace Assets.SimpleEncryption
{
    ...
    {
        /// <summary>
        /// Key length, 128 (default) or 256.
        /// </summary>
        public static int KeyLength = 128;
        private const string SaltKey = "ShMG8hLyZ7k~Ge5@";
        private const string VIKey = "~6YUi0Sv5@|{aOZO"; // TODO: It's strongly recommended to generate random VI each encryption (and store it with encrypted value)
