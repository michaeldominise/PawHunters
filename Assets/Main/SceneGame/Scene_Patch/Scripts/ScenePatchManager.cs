...
namespace LabHaven.PawHunters
{
    public class ScenePatchManager : SingletonMonoBehaviour<ScenePatchManager>
    {
...
#if UNITY_EDITOR
        [SerializeField, HideInInspector] UnityEditor.AddressableAssets.Settings.AddressableAssetGroup[] addressableAssetGroups;
        [ShowInInspector, HideReferenceObjectPicker] UnityEditor.AddressableAssets.Settings.AddressableAssetGroup[] AddressableAssetGroups
        {
            get => addressableAssetGroups;
            set
            {
                addressableAssetGroups = value;
                addressableAssetGroupNames = addressableAssetGroups.Select(x => x.name).ToArray();
            }
        }
#endif
        [SerializeField, HideInInspector] string[] addressableAssetGroupNames;
        ...
        async void Start()
        {
            ...
            operation = AppManager.Instance.LoadScene(nextScene);
