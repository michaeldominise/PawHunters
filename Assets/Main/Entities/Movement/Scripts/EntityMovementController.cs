...
namespace PawHunters
{
    public abstract class EntityMovementController : MonoBehaviour
    {
        ...
        public async Task MoveToFront(EntityMainController moveTo, bool isRunning = true) => await MoveTo(moveTo.transform.TransformPoint(Vector3.right * 4) + 0.001f * Vector3.back, isRunning, false);
